...
O Sistema de Controle de Estoque para uma loja de eletrônicos de médio porte tem como objetivo auxiliar no cadastro e acompanhamento dos produtos e de suas movimentações. O sistema deve permitir registrar entradas, saídas, perdas e ajustes, além de facilitar a consulta das informações e do histórico do estoque.

Requisitos já consolidados no requisitos.md:
