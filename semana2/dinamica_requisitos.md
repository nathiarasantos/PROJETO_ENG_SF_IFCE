...
*Carlos Eduardo, Gerente operacional da loja, responsável pelo acompanhamento do estoque, compras e equipe. Precisa de informações atualizadas sobre produtos, quantidades, movimentações e reposição para auxiliar na tomada de decisões.*
